...
function promptSetup () {
    ...
    terminfo_down=$terminfo[cud1]$terminfo[cuu1]$terminfo[sc]$terminfo[cud1]

    # Finally, the prompt.
    PS1=$'\n'                     # newline (specially quotet, see zsh FAQ 3.13)
    PS1+="%{$terminfo_down$VCS_LINE$terminfo[rc]%}" # the second line
    # PS1+="%{$terminfo_down$HOSTNAME_LINE$terminfo[rc]%}" # the second line
